          ...
          <table class="table table-hover table-striped">
            ...
            @foreach ($sliders as $slider)
              <tr>
                ...
                <td>
                  <a href="#editModal{{ $slider->id }}" data-bs-toggle="modal" class="btn btn-success">Edit</a>

                  <a href="#deleteModal{{ $slider->id }}" data-bs-toggle="modal" class="btn btn-danger">Delete</a>
