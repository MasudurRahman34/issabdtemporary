...
use App\Http\Controllers\Backend\EventProductsController as BackendEventProductsController;
...
Route::group(['prefix' => 'products'], function () {
  ...
  Route::get('/discount/{id}', [FrontendProductsController::class, 'groupDiscProduct'])->name('products.group.discount');
  // Route::get('//{id}', [FrontendProductsController::class, 'groupDiscProduct'])->name('products.group.discount');
...
Route::group(['prefix' => 'admin'], function () {
  ...
  Route::group(['prefix' => '/products'], function () {
    ...
    Route::post('/groupdiscount/{productid}', [BackendEventProductsController::class, 'store'])->name('admin.event.product.store');
    Route::post('/event/update/{eventProducts}', [BackendEventProductsController::class, 'update'])->name('admin.event.product.update');
    Route::get('/event/edit/{eventProducts}', [BackendEventProductsController::class, 'edit'])->name('admin.event.product.edit');
    // Route::post('/disc/{productid}', [BackendEventProductsController::class, 'store'])->name('admin.event.product.store');
  ...
  Route::group(['prefix' => '/orders'], function () {
    ...
    Route::post('/completed/{id}', [OrdersController::class, 'confirm'])->name('admin.order.confirm');
